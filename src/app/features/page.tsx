              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                    Elevate Your Final Year Projects
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Our platform empowers students to seamlessly upload, manage,
                    and showcase their final year projects, with features to
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ...
                  help you seamlessly manage your final year project, from
              ...
              <div className="grid gap-6">
                <div className="grid gap-1">
                  ...
                  <p className="text-muted-foreground">
                    Easily upload your final year project files and documents,
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-muted-foreground">
                    Collaborate with your peers and receive valuable feedback to
                    improve your project.
                  </p>
                </div>
                <div className="grid gap-1">
                  <div className="flex items-center gap-2">
                    <WaypointsIcon className="h-6 w-6 text-primary" />
                    <h3 className="text-lg font-bold">Progress Tracking</h3>
                  </div>
                  <p className="text-muted-foreground">
                    Monitor your project&rsquo;s progress and stay on top of
                    deadlines with our intuitive tracking tools.
                  </p>
                </div>
              </div>
              <div className="grid gap-6">
                <div className="grid gap-1">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-lg font-bold">Faculty Guidance</h3>
                  </div>
                  <p className="text-muted-foreground">
                    Receive valuable feedback and guidance from your faculty
                    mentors throughout your project journey.
                  </p>
                </div>
                <div className="grid gap-1">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-muted-foreground">
                    Showcase your final year project to potential employers and
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-muted-foreground">
                    Collaborate seamlessly with your team members and faculty
                    mentors throughout the project lifecycle.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">
                Elevate Your Final Year Project
              </h2>
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Our platform provides the tools and support you need to
                successfully complete and showcase your final year project.
              </p>
            </div>
...
function UploadIllustration(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      ...
      <path
        ...
        fill="#e6e6e6"
      />
      <circle cx="357.75864" cy="208.28689" r="29.56668" fill="#004c23" />
      <path
